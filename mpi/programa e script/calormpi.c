...
void discretizar(double w[][Y], double aux[][Y] , double lambda, int linha, int coluna,int rank,int size)
{
	...
	//printf("Estou discretizando RANK: %d\n",rank);
		...
		if(rank == 0)
		{
		        //printf("Sou o rank %d e sou o primeiro rank\n",rank);
		        for(i = 1; i < linha ; i++)
		        {
		...
		{
		        //printf("Sou o rank %d e sou o ultimo rank\n",rank);
		        for(i = 0; i < linha-1 ; i++)
		        {
		                for(j = 1; j < coluna-1 ; j++)
		                 {
		...
		{
		        //printf("Sou o rank %d e estou no meio\n",rank);
		        for(i = 0; i < linha ; i++)
		        {
		                for(j = 1; j < coluna-1 ; j++)
		                 {
        ...
        {
                //printf("Sou o rank %d e sou o unico processo\n",rank);
                for(i = 1; i < linha-1 ; i++)
                {
                        for(j = 1; j < coluna-1 ; j++)
                         {
